    ...
    <div class=" w-full max-w-[1150px]  overflow-x-auto  pr-[10px] pl-[10px] ">
      ...
      <div class="flex gap-[10px] bg-[black] p-[5px]">
        ...
        <div class="rounded-[25px] min-w-[280px] max-w-[280px] mt-[5px]">
            ...
            <button class="bg-[red] text-white p-[6px] pr-[8px] pl-[8px] rounded-[4px]"
     ...
     <div class="mb-[20px] text-center font-bold bg-[darkblue] rounded-[2px]
         text-center pt-[8px] pb-[8px]
          border-[1px] border-white cursor-pointer">Page Supprimer</div>
    @endteleport
...
<div class="grid grid-cols-[1fr_1fr_1fr_1fr_1fr] gap-[10px] min-w-[1020px] max-w-[1200px] m-auto mt-[15px]">
   ...
   @foreach($lesheures as $lesheure)
    ...
    @if($lesheure->userid == 0)
     ...
     <div>
          ...
          <div wire:confirm="voulez vous retirez cette Heure?"  wire:click="supprimer1('{{$lesheure->id}}')" 
           class="bg-[#000077] text-white text-center rounded-[3px] pt-[8px] pb-[8px]">
           <i class="fa fa-trash" aria-hidden="true"></i>  {{$lesheure->debut}}
        </div>
    ...
    @if($lesheure->userid  != 0)
     ...
     <div>
          ...
          <div class="bg-red-600 text-white text-center rounded-[3px] pt-[8px] pb-[8px]"
          wire:confirm="voulez vous retirez cette Heure?"  wire:click="supprimer2('{{$lesheure->id}}')" 
          > <i class="fa fa-trash" aria-hidden="true"></i>  {{$lesheure->debut}} </div>
